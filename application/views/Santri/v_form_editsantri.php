...
<form class="form-horizontal" method="post" onsubmit="return cekform();" action="<?php echo base_url(); ?>Santri/simpan">
	<div class="form-group">
		...
		<div class="col-sm-9">
			<input type="text" id="nis" placeholder="NIS" name="nis" class="col-xs-10 col-sm-5" value="<?php echo $NIS;?>" readonly/>
		</div>
	</div>
	...
	<div class="form-group">
		...
		<div class="col-sm-9">
			<input type="text" id="nama" placeholder="Nama Santri" name="nama" class="col-xs-10 col-sm-5" value="<?php echo $nama;?>"/>
		</div>
	</div>
	...
	<div class="form-group">
		...
		<div class="col-sm-9">
			<input type="text" id="nama_wali" placeholder="Nama Wali" name="nama_wali" class="col-xs-10 col-sm-5" value="<?php echo $nama_wali;?>"/>
		</div>
	</div>
	<div class="form-group">
	...
	<div class="form-group">
		...
		<div class="col-sm-4">
			<div class="input-group input-group-sm">
				<input type="date" id="tgl_masuk" name="tgl_masuk" class="form-control" value="<?php echo $tgl_masuk;?>"/>
	...
	<div class="form-group">
		...
		<div class="col-sm-9">
			<input type="text" id="kamar" placeholder="Kamar" name="kamar" class="col-xs-10 col-sm-5" value="<?php echo $kamar;?>"/>
		</div>
	</div>
	<div class="form-group">
		...
		<div class="col-sm-9">
			<input type="text" id="tmp_lahir" placeholder="Tempat Lahir" name="tmp_lahir" class="col-xs-10 col-sm-5" value="<?php echo $tmp_lahir;?>"/>
		</div>
	</div>
