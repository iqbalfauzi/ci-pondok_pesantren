				...
				<ul class="nav ace-nav">
					...
					<li class="light-blue">
						<a data-toggle="dropdown" href="#" class="dropdown-toggle">
							<img class="nav-user-photo" src="<?php echo base_url();?>assets/avatars/avatar.png" alt="Jason's Photo" />
			...
			<div class="footer-inner">
				<div class="footer-content">
					<span class="bigger-120">
						<span class="blue bolder">SI SANTRI</span>
						PP.Anwarul Huda &copy; 2017
					</span>
					...
					<span class="action-buttons">
						...
						<a href="https://www.facebook.com/iqbal.f.deducation">
