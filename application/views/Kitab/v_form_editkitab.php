...
<form class="form-horizontal" method="post" onsubmit="return cekform();" action="<?php echo base_url(); ?>Kitab/simpan">
	<div class="form-group">
		...
		<div class="col-sm-7">
			<input type="text" id="kode_pelajaran" placeholder="kode pelajaran" name="kode_pelajaran" class="col-xs-10 col-sm-5" value="<?php echo $kode_pelajaran;?>" readonly/>
		</div>
	</div>
	...
	<div class="form-group">
		...
		<div class="col-sm-7">
			<input type="text" id="nama_pelajaran" placeholder="nama pelajaran" name="nama pelajaran" class="col-xs-10 col-sm-5" value="<?php echo $nama_pelajaran;?>"/>
		</div>
	</div>
	...
	<div class="form-group">
		...
		<div class="col-sm-7">
			<input type="text" id="kitab" placeholder="kitab" name="kitab" class="col-xs-10 col-sm-5" value="<?php echo $kitab;?>"/>
		</div>
	</div>
