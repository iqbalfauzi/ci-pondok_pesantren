	...
	<div class="col-xs-12">
		...
		<div class="row">
			<div class="col-xs-12">
				...
				<a href="<?php echo base_url();?>Profile" class="btn btn-app btn-warning no-radius">
					<i class="ace-icon fa fa-lock bigger-230"></i>
					Admin</br>
					<b1><?php echo $data['jml_Admin']; ?></b1>
					<span class="badge badge-warning badge-left"><?php echo $data['jml_Admin']; ?></span>
				</a>
